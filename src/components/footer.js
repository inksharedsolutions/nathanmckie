				...
				<div className="columns navlist-footer-column">
					<div className="column text-center trademark-heading">
						<div className="logo-footer-container">
							...
							<h1>Nathan W. McKie Sr.</h1>
						</div>

						<p>
							Nathan W. McKie Sr. loves to hear from readers. You can reach him via email. Feel free to send
				...
				<div className="columns">
					...
					<div className="column text-center trademark-heading">
						<nav id="style_soc_medias">
							<a
								href="https://www.facebook.com/Nathan-W-McKie-323170622439990"
								target="_blank"
